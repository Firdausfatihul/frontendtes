<?php include('../include/menu.php') ?>
    ...
    <div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" id="idpop"></input>
            <input type="hidden" id="urutanpop"></input>
          <div class="mb-3">
          <label>Image Name</label>
        <input type="text" class="form-control" id="nameboxpop" />
        <label id="extlabpop"></label>
        <img id="myimgpop"> <label id="upprogresspop"></label> <br> <br>
      ...
      <div class="mb-3">
        <label for="" class="form-label">Subtitle</label>
        <input type="text" class="form-control" id="subtitlemodal" />
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Explain</label>
        <input type="text" class="form-control" id="explainmodal" />
      </div>
          </div>
